...
from meanshift.helpers.kcenter_greedy import kCenterGreedy
...
class STPM(pl.LightningModule):
    ...
    def training_epoch_end(self, outputs): 
        ...
        # print(total_embeddings.shape[0], args.coreset_sampling_ratio, int(total_embeddings.shape[0]*args.coreset_sampling_ratio))
